...
Ví dụ:
    python giautin.py host.png wm.png watermarked.png 0.01
"""
...
def main():
    ...
    if len(sys.argv) < 3:
        ...
        print("Ví dụ    : python giautin.py host.png wm.png watermarked.png 0.01")
        sys.exit(1)

    duong_dan_goc = sys.argv[1]
    duong_dan_wm  = sys.argv[2]
    duong_dan_out = sys.argv[3] if len(sys.argv) > 3 else "watermarked.png"
